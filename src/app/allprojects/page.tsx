...
const projects = [
  // Frontend Projects
  {
    ...
    description:
      "A responsive landing page with sleek animations and modern UI design built with HTML/CSS/JS",
    tags: ["HTML", "CSS"],
    type: "frontend",
  ...
  },
  {
    ...
    title: "Modern web",
    description:
      "Interactive e-commerce interface with product listings and shopping cart functionality",
  ...
  },
  {
    ...
    description:
      "Admin dashboard built with Next.js featuring responsive layout and data visualization",
  ...
  },
  {
    ...
    description:
      "Hackathon-winning UI/UX design implementation with focus on accessibility",
  ...
  },
  {
    ...
    description:
      "Content-focused blog website with responsive layout and clean typography",
  ...
  },
  {
    ...
    description:
      "Vibrant landing page for a lemon product with responsive design",
  ...
  // Streamlit Projects
  {
    ...
    demoUrl:
      "https://growthmindsetchallengeprojectbypythongit-czps3v4hhqnsqq4c98r3f.streamlit.app/",
    githubUrl:
      "https://github.com/ZakheerAli/Growth_Mindset_challenge_project-PYTHON-",
  },
  {
    id: 10,
    ...
    githubUrl:
      "https://github.com/ZakheerAli/Password-Strength-Checker-using-python-and-streamlit",
  },
  {
    id: 11,
    title: "Unit Converter",
    description:
      "This app allows users to convert between different units of length, weight, and time. Whether you're a student, a professional, or just someone who loves to cook, this app is for you!",
    tags: ["Python", "Streamlit"],
    type: "streamlit",
    image: "/unit con.PNG",
    demoUrl:
      "https://zakheer-ali-unit-converter-app-using-python74.streamlit.app/",
    githubUrl:
      "https://github.com/ZakheerAli/Unit-Converter-App-using-python-and-streamlit",
  },
  ...
  // Python CLI Projects
  {
    ...
    githubUrl:
      "https://github.com/ZakheerAli/Personal-Library-Manager-using-Python",
  },
  {
    id: 13,
    ...
    githubUrl:
      "https://github.com/ZakheerAli/python-project4-assignments/tree/main/Assignment%201%20to%206",
  },
  {
    id: 14,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Collection of my frontend websites, Streamlit dashboards, and Python
            CLI tools
          </p>
        </motion.div>
            ...
            >
              ...
              {hoveredId === project.id && (
                ...
                >
                  ...
                  >
                    {project.demoUrl ? "View Live Demo" : "View Source Code"}{" "}
